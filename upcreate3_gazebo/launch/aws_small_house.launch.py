...
def generate_launch_description():
    ...
    upcreate_gazebo_path = get_package_share_directory('upcreate3_gazebo')

    # Paths
    empty_world = PathJoinSubstitution(
        [upcreate_gazebo_path, 'launch', 'empty_world.launch.py'])
    ...
    world_spawn = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([empty_world]),
